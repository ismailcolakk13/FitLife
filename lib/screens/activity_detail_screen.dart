...
class _ActivityDetailScreenState extends State<ActivityDetailScreen> {
  final List<Map<String, dynamic>> activities = [
    {'name': '🏃 Koşu', 'icon': Icons.directions_run, 'color': Colors.orange, 'calories': 12},
    {'name': '🚶 Yürüyüş', 'icon': Icons.directions_walk, 'color': Colors.blue, 'calories': 5},
    {'name': '🏊 Yüzme', 'icon': Icons.pool, 'color': Colors.cyan, 'calories': 11},
    {'name': '🚴 Bisiklet', 'icon': Icons.two_wheeler, 'color': Colors.green, 'calories': 10},
    {'name': '🧘 Yoga', 'icon': Icons.self_improvement, 'color': Colors.purple, 'calories': 4},
    {'name': '⛹️ Basketbol', 'icon': Icons.sports_basketball, 'color': Colors.amber, 'calories': 8},
  ];
                  ...
                  return Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: activity['color'].withValues(alpha: 0.2), width: 1),
                        boxShadow: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _ActivityStat(
                          label: 'Toplam Süre',
                          value: '${addedActivities.fold<int>(0, (sum, a) => sum + a['duration'] as int)} dk',
                          color: Colors.purple,
                        ),
                        _ActivityStat(
                          label: 'Toplam Kalori',
                          value: '${addedActivities.fold<int>(0, (sum, a) => sum + a['calories'] as int)} kcal',
                          color: Colors.orange,
                        ),
                      ],
                    ),
